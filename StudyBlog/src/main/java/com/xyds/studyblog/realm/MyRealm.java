...
//            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo("mike", "123456", this.getName());  
//            this.setSession("currentUser", "mike");  
//            return authcInfo;  
//        }else if("碧琳".equals(token.getUsername())){  
//            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo("碧琳", "123456", this.getName());  
